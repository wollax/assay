...
#[cfg(feature = "orchestrate")]
pub use orchestrate::{
    ConflictAction, ConflictResolutionConfig, FailurePolicy, MergePlan, MergePlanEntry,
    MergeReport, MergeSessionResult, MergeSessionStatus, MergeStrategy, OrchestratorPhase,
