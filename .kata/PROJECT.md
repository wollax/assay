...
**M011 (in progress):** Concrete Remote Backends — S01 delivered assay-backends crate scaffold with linear/github/ssh feature flags, StateBackendConfig::Linear/GitHub/Ssh variants, schema snapshots updated, backend_from_config() factory fn dispatching all variants. R079 validated. 1499 tests. S02 delivered LinearBackend implementing all 7 StateBackend methods (reqwest::blocking GraphQL client, .linear-issue-id file lifecycle, annotate_run [assay:manifest] tag, D164 capability flags), 8 mockito contract tests, factory dispatch updated. R076 validated. 1501 tests. S03 (GitHubBackend) and S04 (SshSyncBackend + CLI/MCP wiring) remain.
...
- [ ] M011: Concrete Remote Backends — LinearBackend ✅, GitHubBackend, SshSyncBackend in new assay-backends crate; backend factory fn; StateBackendConfig named variants (S02 complete, S03/S04 remaining)
