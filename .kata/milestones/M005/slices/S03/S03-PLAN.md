...
- [x] **T02: Implement `assay-core::wizard` module** `est:60m`
...
- [x] **T03: Add `assay plan` CLI command with dialoguer** `est:45m`
...
- [x] **T04: Implement `milestone_create` and `spec_create` MCP tools** `est:45m`
