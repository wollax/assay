...
- [ ] **T02: Implement milestone_load, milestone_save, milestone_scan in assay-core** `est:1.5h`
...
- [ ] **T03: Register milestone_list and milestone_get MCP tools and add assay milestone CLI stub** `est:1.5h`
