...
name: check
description: >
  Run quality gates with smart routing — auto-detects criterion types and picks the right evaluation path.
  Use when checking if code meets spec criteria, after implementing features, or when asked about gate status.
  Replaces /assay:gate-check with expanded capability.
---
