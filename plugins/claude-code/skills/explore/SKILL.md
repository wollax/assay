...
name: explore
description: >
  Conversational requirements discovery. Loads a lean Assay project summary (~2K tokens) for brainstorming, research, and architectural decisions.
  Use when the user wants to think through a problem, explore ideas, or understand the project before planning.
---
